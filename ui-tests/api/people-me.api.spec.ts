...
import { PeopleGraphService } from '../../src/services/StorageExplorer/PeopleGraphService';
import { MeGraphService } from '../../src/services/StorageExplorer/MeGraphService';
...
test.describe('PeopleGraphService', () => {
    test('searchUsers() → GET /users with $search + ConsistencyLevel', async () => {
        ...
        const s = new PeopleGraphService(fake as unknown as Client);
...
test.describe('MeGraphService', () => {
    test('get() → GET /me', async () => {
        ...
        const s = new MeGraphService(fake as unknown as Client);
        await s.get();
